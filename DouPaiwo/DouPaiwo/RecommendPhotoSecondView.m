...
#define kRecommendPhotoSecondViewBigFontSize 12
@interface RecommendPhotoSecondView ()
...
@implementation RecommendPhotoSecondView
...
#pragma init
- (void)initARecommendPhotoSecondViewControllerWithAlbum  :(AlbumInstance*)album;
{
  self.album =  album;
}
...
- (UILabel*)byLabel
{
  if(_byLabel ==  nil)
  {
    ...
    [_byLabel  setFont:[UIFont boldSystemFontOfSize:kRecommendPhotoSecondViewBigFontSize]];
