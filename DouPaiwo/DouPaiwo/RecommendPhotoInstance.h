...
typedef NS_ENUM(NSInteger, RecommendPhotoType) {
    recommend_photo=5,
};
@interface RecommendPhotoInstance : NSObject
/**
 ...
 *  图片类型
 */
@property (nonatomic,readwrite)    RecommendPhotoType   type;
/**
