...
- (void)layoutSubviews
{
  ...
  if(self.textfieldType ==  type_phone_password)
  {
  ...
  else  if(self.textfieldType ==  type_captcha_password)
  {
  ...
  else  if(self.textfieldType ==  type_password_content)
  {
    [_getMessageButton    removeFromSuperview];
    [self.textFieldImageView mas_makeConstraints:^(MASConstraintMaker *make){
      make.left.equalTo(self).offset(40);
  ...
  else  if(self.textfieldType ==  type_email_password)
  {
    [_getMessageButton    removeFromSuperview];
    [self.textFieldImageView mas_makeConstraints:^(MASConstraintMaker *make){
      make.left.equalTo(self).offset(40);
...
- (void)configWithPlaceholder:(NSString *)phStr  valueStr:(NSString *)valueStr textfieldType:(NSInteger)textfieldType
{
  ...
  self.textField.attributedText         = [[NSAttributedString alloc] initWithString:attrText attributes:@{NSForegroundColorAttributeName: [UIColor colorWithHexString:@"414141" andAlpha: 1.0],NSFontAttributeName:SourceHanSansNormal15}];
}
